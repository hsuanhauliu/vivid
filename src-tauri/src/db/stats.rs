...
pub fn get_library_stats(conn: &Connection) -> rusqlite::Result<LibraryStats> {
    let (total_images, total_videos, total_audio, total_indexed, total_unindexed, total_size_bytes): (
